...
class JsonObjectDiffTests {
    ...
    void compareJsonObjectsAndCheckForDoNotMatchAnyDifferencesFromArrayObject() {
        ...
        String actual1 = """
                ...
                """;
        error = assertThrows(AssertionError.class, () -> JSONCompare.compare(expected1, actual1).modes(CompareMode.JSON_OBJECT_NON_EXTENSIBLE).assertMatches());
        assertTrue(error.getMessage().matches("(?s).*FOUND 4 DIFFERENCE.*" +
                "\\Q$.a\\E.*Expected value: 0 But got: 1.*" +
    ...
    void compareJsonObjectsAndCheckForMismatchDifferences() {
        ...
        String actual = """
                ...
                """;
        AssertionError error = assertThrows(AssertionError.class, () -> JSONCompare.compare(expected, actual).message("My custom message").assertMatches());
    ...
    void compareJsonObjectsWithJsonArraysAndDoNotMatchAny() {
        ...
        String actual0 = """
                ...
                """;
        error = assertThrows(AssertionError.class, () -> JSONCompare.compare(expected0, actual0).assertMatches());
        assertTrue(error.getMessage().matches("(?s).*FOUND 1 DIFFERENCE.*" +
                "\\Q$.\"!.*\"\\E condition was not met. Actual JSON OBJECT has extra fields.*"));
    ...
    void compareJsonsWithUseCases() {
        ...
        String actual1 = """
                ...
                """;
        AssertionError error = assertThrows(AssertionError.class, () -> JSONCompare.compare(expected1, actual1).assertMatches());
        ...
        String actual2 = """
                ...
                """;
        error = assertThrows(AssertionError.class, () -> JSONCompare.compare(expected2, actual2).assertMatches());
        assertTrue(error.getMessage().matches("(?s).*FOUND 3 DIFFERENCE.*" +
        ...
        String actual3 = """
                ...
                """;
        error = assertThrows(AssertionError.class, () -> JSONCompare.compare(expected3, actual3).assertMatches());
        assertTrue(error.getMessage().matches("(?s).*FOUND 1 DIFFERENCE.*" +
                "\\Q$..*\\E was not found.*"));
    }
